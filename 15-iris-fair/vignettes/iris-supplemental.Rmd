...
travel), loading IRIS-DGE through R while internet is still available will 
allow users to utilize IRIS-DGE without an internet connection later on. 

Installing the local application via 
[GitHub](https://github.com/btmonier/iris) will also let the user have 
access to more "developmental" versions of IRIS-DGE. Be warned though; 
